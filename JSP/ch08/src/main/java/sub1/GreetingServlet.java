...
public class GreetingServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		writer.println("</head>");
		writer.println("<body>");
		writer.println("<h3>GreetingServlet doGet</h3><br/>");
		writer.println("<a href='/ch08/Servlet.jsp'>서블릿 메인</a><br/>");
		writer.println("<a href='/ch08/hello.do'>Greeting Servlet</a><br/>");
		writer.println("<a href='/ch08/welcom.do'>Greeting Servlet</a><br/>");
